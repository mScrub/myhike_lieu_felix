...
b=b&&0<b.length?Number(b[0]):-1;var d=!!navigator.userAgent.match(/WebKit/i)&&!navigator.userAgent.match(/CriOS/i);return a&&d&&15<=b};f.prototype.getHostnameFromUrl=function(a){window.URL&&"function"===typeof window.URL?a=(new URL(a)).hostname:(a=-1<a.indexOf("//")?a.split("/")[2]:a.split("/")[0],a=a.split(":")[0],a=a.split("?")[0]);return a};f.prototype.isProtocolHttpOrHttps=function(a){var b;try{return(b=window.URL&&"function"===typeof window.URL?(new URL(a)).protocol:a.split("/")[0])&&"string"===
